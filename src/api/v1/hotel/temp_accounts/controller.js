...
const getAll_Temp_Records = async (req, res) => {
    try {
...
const get_TempRecord_By_Id = async (req, res) => {
    try {
        await connectToDB(); // Ensure DB connection
        const { id } = req.params;
...
const add_Temp_Record = async (req, res) => {
    try {
        await connectToDB();  // Ensure DB connection
...
const update_Temp_Record = async (req, res) => {
    try {
        await connectToDB();
        const { id } = req.params;
...
module.exports = {
    getAll_Temp_Records, get_TempRecord_By_Id, add_Temp_Record, update_Temp_Record
}